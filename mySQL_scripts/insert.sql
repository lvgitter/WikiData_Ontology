...
LOAD DATA LOCAL INFILE ../roles/BookWrittenIn.txt INTO TABLE BookWrittenIn
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;
...
LOAD DATA LOCAL INFILE ../concepts/City.txt INTO TABLE City
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;
...
LOAD DATA LOCAL INFILE ../concepts/FictionalNonHuman.txt INTO TABLE FictionalNonHuman
FIELDS TERMINATED BY ';'
ENCLOSED BY '"'
LINES TERMINATED BY '\n'
IGNORE 1 LINES;
