...
log_file_path = "../log/log_HumanCharacters.txt"
...
humans = list((set([x.strip() for x in human_characters_file.readlines()[1:]]).difference(processed_humans)))
...
log_file.write("Number of human characters: " + str(n_humans)+"\n")
